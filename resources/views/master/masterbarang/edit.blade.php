            ...
            <div class="docs-content-area">
                ...
                <form action="/master-barang/update/{{ $getMasterBarangbyId->id }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kode_barang" name="kode_barang" value="{{ $getMasterBarangbyId->kode_barang }}" maxlength="12" size="12">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="harga_beli" class="form-label">Harga Beli (USD)</label>
                        <input type="text" class="form-control" id="harga_beli" name="harga_beli" value="{{ $getMasterBarangbyId->harga_beli }}">
                    </div>
                    <div class="mb-3">
                        <label for="harga_jual" class="form-label">Harga Jual (IDR)</label>
                        <input type="text" class="form-control" id="harga_jual" name="harga_jual" value="{{ $getMasterBarangbyId->harga_jual }}">
                    </div>
